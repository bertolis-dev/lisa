...
'second-degre': [
  { apres: 'Fonction polynôme du second degré', f: function(){
    const g1 = '<g transform="translate(0,0)">' +
      ...
      trace(x => 0.55 * x * x - 1.6, -3.1, 3.1, 112, 96, 26, 26) +
    ...
    return fig(460, 178, g1 + g2, 'Le signe de ' + M('a') + ' décide du sens de la parabole — et donc si le sommet est un minimum ou un maximum.');
  }},
